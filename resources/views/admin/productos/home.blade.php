            ...
            <div class="inside">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                                ...
                                <td>
                                    <div class="opts">
                                        ...
                                        @if (kvfj(Auth::user()->permisos, 'producto_eliminar'))
                                            ...
                                            <a href="#" data-togger="tooltip" data-path="admin/producto" data-action="eliminar" data-object="{{ $p->id }}"
                                                data-placement="top" title="Eliminar" class="btn-eliminar">
                                                <i class="fa-regular fa-trash-can"></i>
                                            </a>
                                            @else
                                            <a href="{{ url('/admin/producto/'.$p->id.'/restaurar') }}" data-action="restaurar" data-togger="tooltip" data-path="admin/producto" data-object="{{ $p->id }}"
                                                data-placement="top" title="Restaurar" class="btn-eliminar">
                        ...
                        <tr>
                            <td colspan="6">{!! $productos->render() !!}</td>
                        </tr>
